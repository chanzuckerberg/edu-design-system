...
// id is required in InputProps but optional in CheckboxProps.
// Flow does not interpret that intersection correctly, so we
...
const svg_viewbox_size = 20;
const svg_size_rem = `${svg_viewbox_size / 16}rem`;
const svgStyle: SvgStyle = {
  // prettier insists that this variable is lowercase so that's what we'll do
  "--checkbox-svg-size": svg_size_rem,
};
