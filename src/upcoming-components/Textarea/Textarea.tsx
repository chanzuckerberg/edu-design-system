 ...
 *
 * ```ts
 * import {Textarea} from "@chanzuckerberg/eds";
 * ```
 *
 * Textarea component presents the container for the text lists and items with passed in props maximum length and error styles
 * with addtional styles.
 */
