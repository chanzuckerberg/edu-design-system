...
/**
 * Import paths that changed from EDS v17 to v18
 *
...
/**
 * Known prop changes for updated components from EDS v17 to v18
 *
...
export const PropChanges: EditJsxPropChange[] = [
  {
    ...
    edits: [
      {
        type: 'update_name',
        oldPropName: 'subtitle',
        newPropName: 'subTitle',
      },
    ],
  },
  {
...
/**
 * Runs the migration to upgrade EDS from v17 to v18
 */
